...
import TermsSectionItem from "./TermsSectionItem";
import { execornerTerms } from "../data/TermsSection";
...
export default function TermsCheckbox({
  ...
  // Untuk handle SSR — document belum ada di server
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  // ─── Seluruh modal dijadikan variabel, lalu di-portal ke document.body ───
  const modalContent = (
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between gap-3 px-5 sm:px-6 py-4 border-t border-gray-100">
              ...
              <motion.button
                ...
                whileTap={scrolledToBottom ? { scale: 0.97 } : {}}
