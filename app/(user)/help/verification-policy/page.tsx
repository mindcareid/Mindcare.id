...
function Prose({
  ...
  return (
    <p
      className={cn(
        "mt-4 max-w-prose text-base leading-relaxed text-muted-foreground",
        className,
      )}
    >
      {children}
        ...
        <div className="max-w-none">
          ...
          <div className="flex gap-4 rounded-xl border border-border bg-brand-lavender-100 p-5">
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-foreground/80">
                This page describes the checks that will run before real
                listings are published. It is written now, before the first
                submission, on purpose: a promise is easier to keep when it was
                written down before anyone had a reason to bend it.
              </p>
            </div>
          </div>
          ...
          <section className="mt-14 ">
            ...
            <Prose className="max-w-none">
              ...
              body&apos;s own records; and that happened on the date shown next
              to the badge.
            </Prose>
            <Prose className="max-w-none">
              The date is part of the claim, not decoration.
              &ldquo;Checked&rdquo; without a date reads like a permanent state,
              and no check is permanent.
            </Prose>
          </section>
          ...
          <section className="mt-14">
            ...
            <Prose className="max-w-none">
              ...
              quality of anyone&apos;s work. Holding a valid licence and being
              the right person to help you are different questions, and only the
              first one is something a document can answer.
            </Prose>
            <Prose className="max-w-none">
              It is not a check of complaint or disciplinary history. If that
              ever becomes part of the process, it will be said here plainly and
              it will get its own wording — not folded quietly into an existing
              badge.
            </Prose>
            <Prose className="max-w-none">
              It does not transfer. A verified care centre does not make the
              people who practise there verified, and a verified professional
              does not verify the building. Working somewhere is not a
              credential. That is why the two badges are worded differently even
              when they sit on the same page.
            </Prose>
            <Prose className="max-w-none">
              It is not a guarantee of availability, price, or fit, and it is
          ...
          <section className="mt-14">
            ...
            <Prose className="max-w-none">
              ...
              applications, insurer credentialing, permit paperwork — so holding
              a copy proves nothing about whose it is.
            </Prose>
            <Prose className="max-w-none">
              Then the documents themselves: a national registration certificate
              for the profession, and a local permit to practise, which is
              issued for a named place of practice and carries an expiry date.
              Membership of a professional association can be submitted as well,
              but it is treated as supporting information, not as the licence.
            </Prose>
          </section>
          ...
          <section className="mt-14">
            ...
            <Prose className="max-w-none">
              ...
              public records. An accreditation status may be submitted too, but
              it is recorded as supporting information and is not part of what
              the badge asserts — accreditation is a quality judgement made by
              an accrediting body, and this badge deliberately makes none.
            </Prose>
            <Prose className="max-w-none">
              For a facility there is also a step proving that whoever is
              managing the listing is authorised to speak for the place — a
              listing for a hospital has no obvious owner, and that is exactly
              the gap someone else could walk into.
            </Prose>
            <Prose className="max-w-none">
              Public facilities are a deliberate exception to the rule that a
              check starts with a submission. A community health centre or
              public hospital can be checked by Mindcare directly from the
              health ministry&apos;s open records, with nobody applying on its
              behalf. The reason is a bias we would otherwise build in: if a
              badge could only be earned by applying for it, private clinics
              with marketing staff would collect badges while the most
              affordable public services went unmarked — and that gap would land
              hardest on the people with the least room to pay.
            </Prose>
          </section>
          ...
          <section className="mt-14">
            ...
            <Prose className="max-w-none">
              ...
              are still valid, because the detail most likely to change is not
              the licence — it is where someone practises.
            </Prose>
            <Prose className="max-w-none">
              <strong>An absent badge is not an accusation.</strong> A listing
              with no badge may not have applied, may be waiting for review, or
              may have a document whose date has passed. Those are very
              different situations, and none of them is a finding about the
              person or the place. Because the page cannot tell you which one it
              is, it does not guess: the badge is simply not there. Nothing on a
              public page says &ldquo;expired&rdquo; or &ldquo;rejected&rdquo;
              about anyone.
            </Prose>
          </section>
          ...
          <section className="mt-14">
            ...
            <Prose className="max-w-none">
              ...
              date it happened, and where the record came from. Not the
              documents themselves indefinitely: uploaded files are held only as
              long as the review needs them, are never reachable from the public
              site, and are deleted after that.
            </Prose>
            <Prose className="max-w-none">
              Registration and permit numbers are never shown on a public page.
              Once a number is published it cannot be unpublished, and
              displaying it buys the reader nothing they can act on.
            </Prose>
          </section>
          ...
          <section className="mt-14">
            ...
            <Prose className="max-w-none">
              ...
              corrections take priority over new checks. The reporting channel
              is not open yet — like the rest of the site, it is still being
              built, and pointing you at an address that nobody reads would be
              its own small dishonesty. It will be linked from this page and
              from the footer as soon as it works.
            </Prose>
            <Prose className="max-w-none">
          ...
          <div className="mt-14 border-t border-border pt-6">
            <p className="text-sm text-muted-foreground">
              ...
              site; when the wording of a badge changes, this page changes in
              the same edit.
            </p>
          </div>
        </div>
